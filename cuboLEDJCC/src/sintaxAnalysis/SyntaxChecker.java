...
public class SyntaxChecker implements SyntaxCheckerConstants {
  ...
  static final public void IdentificadoresAux() throws ParseException {
    ...
    default:
      jj_la1[5] = jj_gen;
                                                                                                      addVarFalg = true;
      Listas();
                                                                                                                                    grafo.addNodo("INDEXACC",indiceAcceso); indiceAcceso = "";
    }
  }
  ...
  static final public void Iterable() throws ParseException {
    ...
    case ID:
      aux = jj_consume_token(ID);
                                          grafo.addNodo("ID",aux.image); tablaVariables.agregarVariable(numeroVariable,aux.image,scope);
      Iterable_Aux();
                                                                                                                                                          tablaVariables.agregarIndiceAcceso(indiceAcceso); grafo.addNodo("INDEXACC",indiceAcceso); indiceAcceso = ""; tablaVariables.agregarIgualdad(-99,scope,"");
      break;
    case NUM:
      aux = jj_consume_token(NUM);
                                                                       grafo.addNodo("NUM",aux.image); tablaVariables.agregarVariable(-99,"",scope); tablaVariables.agregarIgualdad(numeroVariable,scope,"NUM");
      break;
    case LENGTH:
                                                           valoresIgualdadTabla = new ArrayList<String>();
      FuncionLen();
  ...
  static final public void ifFunction() throws ParseException {
    ...
    case BOOL:
      bool = jj_consume_token(BOOL);
                                                                                        grafo.addNodo("BOOL",bool.image); tablaVariables.agregarVariable(-99,"",scope); tablaVariables.agregarIgualdad(numeroVariable,scope,"BOOL");
      break;
    case NUM:
    case LENGTH:
    case ID:
  ...
  static final public void normalProc() throws ParseException {
    ...
    jj_consume_token(7);
                                                                                         grafo.addNodo("CLOSEPAR",")");
    jj_consume_token(10);
                                                                                                                              grafo.addNodo("OPENSCOPE","{"); scope = 1;
    Exp();
    jj_consume_token(11);
                                                                                                                                                                                     grafo.addNodo("CLOSESCOPE","}"); scope = 0;
  }
  ...
  static final public void Parametros() throws ParseException {
                    Token id;
    id = jj_consume_token(ID);
                                            tablaVariables.agregarParamProc(id.image); grafo.addNodo("ID",id.image);
    ParametrosAux();
  }
  ...
  static final public void forFunction() throws ParseException {
                    Token id;
    jj_consume_token(31);
                                        grafo.addNodo("FOR","for"); scope += 1;
    id = jj_consume_token(ID);
                                                                                          grafo.addNodo("ID",id.image); tablaVariables.agregarVariable(-1,id.image,scope); tablaVariables.agregarIgualdad(-1,scope,"");
    jj_consume_token(35);
                                                                      grafo.addNodo("FORIN","in");  int aux = numeroVariable; numeroVariable=-1;
    Iterable();
                                                                                                                                                              numeroVariable=aux;
                                                                 grafo.addNodo("STEPFOR","step");
    Step();
    jj_consume_token(10);
                                                                                                               grafo.addNodo("OPENSCOPE","{");
    Exp();
